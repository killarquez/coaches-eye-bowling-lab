...
/**
 * 3D Pose Landmark model (compatible with MediaPipe / RTMPose 33 landmarks).
 */
...
/**
 * MediaPipe / BlazePose standard landmark index constants.
 */
...
/**
 * A captured pose frame containing all 33 skeletal landmarks with timestamp.
 */
data class PoseFrame(
    val timestampMs: Long,
    val landmarks: List<PoseLandmark>
) {
    fun getOrNull(index: Int): PoseLandmark? = landmarks.getOrNull(index)
}
